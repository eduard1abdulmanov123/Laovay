package com.abdulmanov.laovay.ui.base
...
class BaseFragment: Fragment() {
    ...
    companion object {
        ...
        fun newInstance(layoutRes: Int, navHostId: Int, firstFragment: String) =
            BaseFragment().apply {
    ...
    override fun onCreateView(
        ...
        return if (layoutRes == -1) null else inflater.inflate(layoutRes, container, false)
    }
